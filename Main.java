...
public class Main {
    public static void main(String[] args) {
        Worker worker1 = new Worker("Tomek", 2300, 1, "2022-11-11", "Junior Developer");
        Worker worker2 = new Worker("Kazik", 2800, 2, "2022-03-15", "Senior Developer");
        Worker worker3 = new Worker("Gawel", 2900, 3, "2021-11-11", "Tester");
        Worker worker4 = new Worker("Pawel", 2500, 4, "2021-06-20", "Project Manager");
        Worker worker5 = new Worker("Adam", 2100, 3, "2024-06-21", "Project Manager");
        Manager manager1 = new Manager("Adi", 6000, 5, "2018-05-14", "Department Head");
        Manager manager2 = new Manager("Ania", 5700, 1, "2019-02-11", "CTO");
