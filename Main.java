...
public class Main {
    public static void main(String[] args) {
        Worker worker1 = new Worker("Tomek", 2100, 1, "2022-10-04", "Junior Developer");
        Worker worker2 = new Worker("Kazik", 2800, 2, "2023-01-11", "Senior Developer");
        Worker worker3 = new Worker("Alicja", 2900, 1, "2021-05-11", "Tester");
        Manager manager = new Manager("Gawel", 6000, 3, "2022-07-12", "Department Head");
